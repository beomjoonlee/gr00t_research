...
if __name__ == "__main__":
    ...
    # Build dataset list: main dataset + optional extra datasets. Each path becomes its
    # own spec (relative_length=1.0), so equal mix_ratios => equal training per dataset
    # regardless of frame count (shard-size normalization cancels dataset size).
